...
export default class Row extends Component {
  ...
  renderFrontface() {
    return (
      <InfoCard onPress={this.flip} data={this.props.data} color={this.props.color} pic={this.props.pic}/>
    );
  }

  renderBackface() {
    return (
      <ProfileCard onPress={this.flip} data={this.props.data} color={this.props.color}/>
    );
  }
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <PhotoCard onPress={this.flip} data={this.props.data} color={this.props.color}/>
          </FoldView>
